...
// Find the index of "      {/* ONLY THE ORIGINAL UNDERGROUNDZ TITLE REVEALED FROM LEFT TO RIGHT */}"
const splitPoint = code.indexOf('      {/* ONLY THE ORIGINAL UNDERGROUNDZ TITLE REVEALED FROM LEFT TO RIGHT */}');
if (splitPoint === -1) {
  console.log('Could not find split point');
  process.exit(1);
}

const cleanEnding = `      {/* ONLY THE ORIGINAL UNDERGROUNDZ TITLE REVEALED FROM LEFT TO RIGHT */}
